...
public class StartUpLogger {
    ...
    public StartUpLogger coloredSpacer(ChatColor color) {
        sender.sendMessage(ReportPlugin.getInstance().getPrefix() + color + SPACER_FORMAT);
        return this;
    }
    ...
    public StartUpLogger message(String message) {
        sender.sendMessage(ReportPlugin.getInstance().getPrefix() + getMessageWithFormat(message));
        return this;
    }

    public StartUpLogger coloredMessage(ChatColor color, String message) {
        sender.sendMessage(ReportPlugin.getInstance().getPrefix() + color + getMessageWithFormat(message));
        return this;
    }

    public StartUpLogger rawMessage(String message) {
        sender.sendMessage(ReportPlugin.getInstance().getPrefix() + message);
        return this;
    }

    public StartUpLogger messages(String... messages) {
        for(String message : messages) sender.sendMessage(ReportPlugin.getInstance().getPrefix() + getMessageWithFormat(message));
        return this;
    }

    public StartUpLogger rawMessages(String... messages) {
        sender.sendMessage(ReportPlugin.getInstance().getPrefix() + messages);
        return this;
    }
